...
# video = cv2.VideoCapture('/home/jeongha/Downloads/Telegram Desktop/line.mp4')
...
while True:
    ...
    # orig_frame = orig_frame[340,200]

    # sub_frame = orig_frame[200:, 0:]
    # orig_frame[283:478, 0:] = sub_frame

    cuttingImg = orig_frame[250:, :]

    orig_frame = cuttingImg
    cv2.imshow('cutting', orig_frame)
