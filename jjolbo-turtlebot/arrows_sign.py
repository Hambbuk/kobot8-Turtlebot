...
if __name__ == '__main__':
    ...
    while success and not clicked:
        ...
        circles = cv2.HoughCircles(img, cv2.HOUGH_GRADIENT, 1, 50, param1=120, param2=55)
        ...
        if not circles is None:
            ...
            if y > r and x > r:
                ...
                if dominant_color[2] > 100:
                    ...
                    zone_0 = square[square.shape[0]*3//10:square.shape[0]
                                    * 5//10, square.shape[1]*1//8:square.shape[1]*3//8]
