...
if __name__ == '__main__':
    ...
    while True:
        ...
        p = 1000
        lineThickness = 2
        cv2.line(draw_temp, (int(a_f / 2 - p * np.cos(ave_theta_real)), b_f + int(p * np.sin(ave_theta_real))),
                 (int((a_f / 2 + p * np.cos(ave_theta_real))), b_f - int(p * np.sin(ave_theta_real))), (0, 255, 0),
                 lineThickness)
